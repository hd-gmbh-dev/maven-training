...
We can just execute the commands below in the project at [demo2/phase1](../../demo2/phase1-solution).
...
In IntelliJ IDEA open the [pom.xml](../../demo2/phase1-solution/pom.xml) and hit `Ctrl`+`Alt`+`Shift`+`U` on 
